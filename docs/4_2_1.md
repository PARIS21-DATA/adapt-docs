...
<span id="_Toc521689461" class="anchor"></span>Figure 46: The Policies
menu – a first glance

<img src="ADAPTmedia\media\image52.png" style="width:6.125in;height:2.60417in" />

<img src="ADAPTmedia\media\image53.png" style="width:2.96806in;height:2.47986in" />
...
<span id="_Toc521689462" class="anchor"></span>Figure 47: What to enter
in the Policies menu

<img src="ADAPTmedia\media\image54.png" style="width:6.19792in;height:2.82879in" />

<span id="_Toc7208963" class="anchor"></span>Box 4 – In Practice!
Entering information vertically (1) and then horizontally (2)
...
<span id="_Toc7209083" class="anchor"></span>Table 3: What to enter in
*Policies*
...
<p>Generally, national policies are applicable at the state level; however, state-level policies may not be applicable at the country level. Thus, ensure that the appropriate boxes are checked. <em><strong>(See Box 6 – Entering geographic coverage)</strong></em></p></td>
</tr>
<tr class="even">
<td></td>
<td></td>
...
<td></td>
<td><p>If Yes,</p>
<p><img src="ADAPTmedia\media\image56.png" style="width:1.35417in;height:0.27083in" /></p></td>
<td><p>You can either go to the next menu item to quickly enter the basic logframe details (if they have not been entered already), so that the drop-down list has the corresponding logframe name, or simply click on <em>Add later</em> and enter the details after the <em>Policy</em> section has been completed.</p>
<p>As this is a cross-cutting field, and the linking occurs by means of a drop-down menu based on logframe names that have already been entered, an <em>Add later</em> option is provided, to allow them to return to this field when the relevant <em>Logframe</em> section has been compiled.</p>
...
<span id="_Toc7208964" class="anchor"></span>Box 5 – Worth noting! The
Completeness score

<img src="ADAPTmedia\media\image57.png" style="width:1.27847in;height:0.32153in" />
...
<span id="_Toc7208851" class="anchor"></span>Figure 48: Progress Report
for Completeness score

<img src="ADAPTmedia\media\image58.png" style="width:6.26806in;height:2.41146in" />

<span id="_Toc7208965" class="anchor"></span>Box 6 – Worth noting!
Entering geographic coverage
...
<span id="_Toc7208966" class="anchor"></span>Box 7 – Worth noting!
Mapping in ADAPT
